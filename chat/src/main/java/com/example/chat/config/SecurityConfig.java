...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://frontend-react.localhost:81", "http://localhost:3000","https://frontend-react.localhost","https://frontend-react.localhost:443")); // Permite originile frontend
